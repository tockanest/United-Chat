...
export default function AppSettings(
	...
	return (
		<div className="container mx-auto p-4">
			<AlertDialog open={startLinkingTwitchAlert} onOpenChange={setStartLinkingTwitchAlert}>
				<AlertDialogContent className="sm:max-w-[425px]">
					...
					<AlertDialogFooter>
						<AlertDialogAction onClick={() => {
							setStartLinkingTwitchAlert(false)
						}}>
							Close
						</AlertDialogAction>
						<AlertDialogAction onClick={() => {
			...
			<Dialog open={startLinkingYtAlert} onOpenChange={setStartLinkingYtAlert}>
				<DialogContent>
					<DialogHeader>
					...
					<Button onClick={() => {
						handleAddNewChannel(newLiveStream.url)
							.then((channel) => {
								console.log(channel)
							})
							.catch((e) => {
					...
					<Card className="mb-4">
						...
						<CardContent>
							<div className="flex items-center justify-between mb-4">
								...
								<Button onClick={() => {
									if (!youtubeConnected) {
										// 	Show the user that the app is going back to the splashscreen to connect to YouTube
